...
for row in cur.execute('SELECT * FROM customers WHERE chassis_cnt > 0 ORDER BY country DESC,state  COLLATE NOCASE '):
    print('{} {} {} {} {} {} '.format(row[0],row[2],row[3],row[4],row[20],row[8]))
    if not int(row[10]) == 0:
